package com.estafet.fis.sales.aggregator.restful.sales.enrichment.db;
...
public class GenerateDBSchema {
	...
	public static void main(String[] args) throws IOException {
		File create = new File("create-enrichment-db.sql");
		File drop = new File("drop-enrichment-db.sql");
		create.delete();
		drop.delete();
